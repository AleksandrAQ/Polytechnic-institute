...
{
    list <Shape*> listin;
    listin.push_back(new Square(10,10));
    listin.push_back(new Triangle(10,15));
    listin.push_back(new Square(16,15));
    listin.push_back(new Circle(10,15));
    listin.push_back(new Square(58,60));
    for_each(listin.begin(), listin.end(), mem_fun(&Shape::Draw));
    cout<<"****"<<endl;

    listin.sort(mem_fun(&Shape::IsMoreLeft));
    for_each(listin.begin(), listin.end(), mem_fun(&Shape::Draw));
    cout<<"****"<<endl;

    listin.sort(not2(mem_fun(&Shape::IsMoreLeft)));
    for_each(listin.begin(), listin.end(), mem_fun(&Shape::Draw));
    cout<<"****"<<endl;

    listin.sort(not2(mem_fun(&Shape::IsUpper)));
    for_each(listin.begin(), listin.end(), mem_fun(&Shape::Draw));
    cout<<"****"<<endl;

    listin.sort(mem_fun(&Shape::IsUpper));
    for_each(listin.begin(), listin.end(), mem_fun(&Shape::Draw));
    cout<<"****"<<endl;
    return 0;
}
