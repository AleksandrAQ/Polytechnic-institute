...
int main ()
{
    ...
    queue.PutElementToQueue("BMV",HIGH);
    queue.PutElementToQueue("Mersedes",LOW);
    queue.PutElementToQueue("Audi",NORMAL);
    queue.PutElementToQueue("Porshe",LOW);
    queue.PutElementToQueue("Lada",LOW);

    queue.PrintAll();
    cout<<endl;
    Element t = queue.GetElementFromQueue();
    cout<<t<<endl<<endl;
    t = queue.GetElementFromQueue();
    queue.PrintAll();
    queue.Accelerate();
    cout<<endl;
    queue.PrintAll();
